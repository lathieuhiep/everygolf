<?php
function everygolf_cmb_block_about_history($prefix, $tpl_name): void
{
    $cmb_block_about_history_group = new_cmb2_box(array(
        'id' => $prefix . 'group',
    ...
    $cmb_block_about_history_group->add_field(array(
