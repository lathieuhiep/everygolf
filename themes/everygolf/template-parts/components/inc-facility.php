                                            ...
                                            <?php foreach ( $post_info as $key => $item ) : ?>
                                                <div class="accordion__panel wow fadeInUp<?php echo esc_attr( $key == 0 ? ' active show' : '' ); ?>">
                                                    <h3 class="accordion__title">
                                                        ...
                                                        <span>
                                                            <img class="acc-up" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/icons/acc-up.svg' ) ) ?>" alt="" width="45" height="45">
                                                            <img class="acc-down" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/icons/acc-down.svg' ) ) ?>" alt="" width="45" height="45">
                                                        </span>
                                                    </h3>
